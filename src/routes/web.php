 ...
 * if not modified in all places that used in (e.g DevsFort class,
 * Controllers, devsfort javascript file...).
 * -----------------------------------------------------------------
 */


/*
* This is the main app route [DevsFort Messenger]
*/
Route::get('/', 'MessagesController@index')->name(config('devschat.path'));
 ...
 */
Route::get('/download/{fileName}', 'MessagesController@download')->name(config('devschat.attachments.route'));
